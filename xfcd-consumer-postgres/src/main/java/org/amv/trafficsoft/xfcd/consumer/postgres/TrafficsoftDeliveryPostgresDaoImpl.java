...
public class TrafficsoftDeliveryPostgresDaoImpl implements TrafficsoftDeliveryJdbcDao {
    private final NamedParameterJdbcTemplate jdbcTemplate;
    private final RowMapper<TrafficsoftDeliveryEntity> rowMapper;

    public TrafficsoftDeliveryPostgresDaoImpl(NamedParameterJdbcTemplate jdbcTemplate,
