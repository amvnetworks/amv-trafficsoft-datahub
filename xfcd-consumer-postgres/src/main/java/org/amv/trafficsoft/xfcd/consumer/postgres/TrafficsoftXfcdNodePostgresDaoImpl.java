...
public class TrafficsoftXfcdNodePostgresDaoImpl implements TrafficsoftXfcdNodeJdbcDao {

    private final NamedParameterJdbcTemplate jdbcTemplate;
    private final RowMapper<TrafficsoftXfcdNodeEntity> rowMapper;

    public TrafficsoftXfcdNodePostgresDaoImpl(NamedParameterJdbcTemplate jdbcTemplate, RowMapper<TrafficsoftXfcdNodeEntity> rowMapper) {
