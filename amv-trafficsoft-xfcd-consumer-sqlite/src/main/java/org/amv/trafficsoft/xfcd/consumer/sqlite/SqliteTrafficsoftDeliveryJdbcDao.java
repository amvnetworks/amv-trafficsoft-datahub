...
@Slf4j
public class SqliteTrafficsoftDeliveryJdbcDao implements TrafficsoftDeliveryJdbcDao {
    private final NamedParameterJdbcTemplate jdbcTemplate;
    private final RowMapper<TrafficsoftDeliveryEntity> rowMapper;

    public SqliteTrafficsoftDeliveryJdbcDao(NamedParameterJdbcTemplate jdbcTemplate,
