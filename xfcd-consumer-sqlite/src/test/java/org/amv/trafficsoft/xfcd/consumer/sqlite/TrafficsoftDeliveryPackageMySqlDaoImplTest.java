...
@Transactional
public class TrafficsoftDeliveryPackageMySqlDaoImplTest {
    ...
    public void setUp() throws SQLException, IOException {
        ...
        this.deliveryDao = new TrafficsoftDeliverySqliteDaoImpl(namedParameterJdbcTemplate,
                deliveryRowMapper);
        TrafficsoftXfcdNodeJdbcDao nodeDao = new TrafficsoftXfcdNodeSqliteDaoImpl(namedParameterJdbcTemplate,
                nodeRowMapper);
        TrafficsoftXfcdStateJdbcDao stateDao = new TrafficsoftXfcdStateSqliteDaoImpl(namedParameterJdbcTemplate,
                stateRowMapper);
        TrafficsoftXfcdXfcdJdbcDao xfcdDao = new TrafficsoftXfcdXfcdSqliteDaoImpl(namedParameterJdbcTemplate,
                xfcdRowMapper);
